#!/usr/bin/env python3
"""
Generate Headless Horseman themed images for VibeGames (Async version)
...
async def main():
    ...
    images = [
        ...
        {
            "prompt": "Minimalist headless horseman logo design, glowing jack-o-lantern pumpkin head floating above a dark silhouette, clean vector style, orange and purple gradient glow effect, simple black background, professional modern design",
    ...
    async with ImageGenerator(config) as generator:
        ...
        # Generate images sequentially with delay
